define.skin('wysiwyg.viewer.skins.gallerymatrix.TextBottomCustomHeightSkin', function(SkinDefinition, experimentStrategy) {
    ...
    def.skinParams([
        ...
        { "id": "paddingSize", "type": Constants.SkinParamTypes.SIZE, "defaultValue": "0px" ,"range": { "min":0, "max":25}}
    ]);
