define.skin('wysiwyg.viewer.skins.button.ShinyButtonIISkin', function(SkinDefinition) {
	...
	def.css([
		'%link% { [pos][rd][trans1] [shd] border:solid [brd] [brw]; cursor:pointer !important; background:[bg] url([tdr]shiny2button_bg.png) center top repeat-x; }',
